 ...
 */
@Entity
@NamedQuery(name = "Alcohol.deleteAllRows", query = "DELETE from Alcohol")
public class Alcohol implements Serializable {
    ...
    public Alcohol(String name, String type, int price, String description) {
        this.name = name;
        this.type = type;
        this.price = price;
    ...
    public Alcohol(AlcoholDTO cdto){
